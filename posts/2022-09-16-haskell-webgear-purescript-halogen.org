...
The client has a problem ([[https://github.com/thomashoneyman/purescript-halogen-realworld/issues/78][issue #78]]) with submitting comments, which
I've started attempting to fix in a fork at:
