...
compensates for its lack of tabs (update: see [[#slayingthezombieswithtermonad][Slaying the zombies with Termonad]] below).
...
** Slaying the zombies with Termonad
    :PROPERTIES:
    :CUSTOM_ID: slayingthezombieswithtermonad
    :END:
