        ...
        hakyllWith config $ do
            ...
            create ["archive.html"] $ do
                ...
                compile $ do
                    ...
                    let myArchiveCtx =
                            listField "posts" myPostCtx (return posts)
                                `mappend` constField "taglist" tagList
            ...
            create ["rss.xml"] $ do
                ...
                compile $ do
                    ...
                    processedPosts <- forM posts $
                        \p -> do
                            pp <- loadAndApplyTemplate "templates/rss-description.html" feedCtx p
...
replaceTeaserSeparatorWith ::
    -- | teaser separator to replace
    String ->
    -- | replacement teaser separator
    String ->
    -- | HTML to replace in
    String ->
    -- | Resulting HTML
